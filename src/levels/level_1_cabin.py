...
def build_level(abilities=None):
    ...
    # Inset by 10px: 2700+10=2710, 100-20=80
    hazard0 = pygame.Rect(2710, 530, 80, 30)
    ...
    # Inset by 10px: 3700+10=3710, 200-20=180
    hazard1 = pygame.Rect(3710, 530, 180, 30)
    ...
    # Inset by 10px: 4300+10=4310, 300-20=280
    hazard2 = pygame.Rect(4310, 530, 280, 30)
